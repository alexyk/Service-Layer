...
export default class Requester {
  ...
  oauth2Twitter(redirectUri,refId) {
    ...
    getStaticHotels(regionId, page = 0, size = 10) {
        ...
        return this._requestSender.sendRequest(
            this._requestEndpoints.GetRoute("GetStaticHotels", [regionId], [`page=${page}`, `size=${size}`]),
            RequestMethods.GET).then(res => res);
    }
     ...
     *
     */
    getDistanceByHotelId(hotelId) {
        return this._requestSender.sendRequest(
            this._requestEndpoints.GetRoute("GetDistanceByHotelId", [hotelId]),
            RequestMethods.GET).then(res => res);
    }
     ...
     *
     */
    getHotelAddress(hotelId) {
        return this._requestSender.sendRequest(
            this._requestEndpoints.GetRoute("GetHotelAddress", [hotelId]),
            RequestMethods.GET).then(res => res);
    }
    ...
    getHotelFeatures(hotelId) {
        return this._requestSender.sendRequest(
            this._requestEndpoints.GetRoute("GetHotelFeatures", [hotelId]),
            RequestMethods.GET).then(res => res);
    }
     ...
     *
     */
    getNearbyHotelsByHotelId(hotelId) {
        return this._requestSender.sendRequest(
            this._requestEndpoints.GetRoute("GetNearbyHotelsByHotelId", [hotelId]),
            RequestMethods.GET).then(res => res);
    }
     ...
     *
     */
    getCancellationPolicyByQuoteId(quoteId) {
        return this._requestSender.sendRequest(
            this._requestEndpoints.GetRoute("GetCancellationPolicyByQuoteId", [quoteId]),
            RequestMethods.GET).then(res => res);
    }
}
