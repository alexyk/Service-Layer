...
var Requester = function () {
  ...
  _createClass(Requester, [{
    ...
    value: function getStaticHotels(regionId) {
      ...
      return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetStaticHotels", [regionId], ['page=' + page, 'size=' + count]), _RequestMethods2.default.GET).then(function (res) {
        return res;
      });
    }
