...
var Requester = function () {
  ...
  _createClass(Requester, [{
    ...
    value: function updateUserAdditionalInfo(userAdditionalInfoObj, captchaToken) {
      return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("UpdateUserAdditionalInfo"), _RequestMethods2.default.POST, userAdditionalInfoObj).then(function (res) {
        return res;
      });
    }
    ...
    value: function getCurrentLocEurRate() {
      return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetCurrentLocEurRate"), _RequestMethods2.default.GET).then(function (res) {
        return res;
      });
    }
  }]);
