...
var Requester = function () {
  ...
  _createClass(Requester, [{
    ...
    value: function verifyCreditCardPayment(url, paymentInfo) {
      return this._requestSender.sendRequest(url, _RequestMethods2.default.POST, paymentInfo).then(function (res) {
        return res;
      });
    }
