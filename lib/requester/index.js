...
var Requester = function () {
    ...
    _createClass(Requester, [{
        ...
        value: function oauth2Facebook(redirectUri) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("Oauth2Facebook", [redirectUri]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function oauth2Google(redirectUri) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("Oauth2Google", [redirectUri]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function oauth2Twitter(redirectUri) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("Oauth2Twitter", [redirectUri]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function getSearchHotelResults(searchTerm) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetSearchHotelResults", [searchTerm]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function getDistanceByHotelId(hotelId) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetDistanceByHotelId", [hotelId]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function getHotelAddress(hotelId) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetHotelAddress", [hotelId]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function getHotelFeatures(hotelId) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetHotelFeatures", [hotelId]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function getNearbyHotelsByHotelId(hotelId) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetNearbyHotelsByHotelId", [hotelId]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
        ...
        value: function getCancellationPolicyByQuoteId(quoteId) {
            return this._requestSender.sendRequest(this._requestEndpoints.GetRoute("GetCancellationPolicyByQuoteId", [quoteId]), _RequestMethods2.default.GET).then(function (res) {
                return res;
            });
        }
    }]);
